...
def main():
    ...
    device = "defaultDevice@cheriperi.cheriperi"  # Replace with the id_developer of your device
    apikey = "6cba079411cc4f82a464f018bd954cb4176b1e5e5379935eff52ff98c797e8f6"  # Replace with your Carriots apikey
    ...
    while True:
        ...
        if lights is not new_lights:  # Check if we have a change in status
            ...
            #carriots_response = client_carriots.send(str.encode("utf-8"))
